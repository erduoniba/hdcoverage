...
NSString *_Nullable SDTransformedKeyForKey(NSString *_Nullable key, NSString *_Nonnull transformerKey) {
    ...
    if (ext.length > 0) {
        ...
        if (keyURL && !keyURL.isFileURL) {
            ...
            component.path =
                [[[component.path.stringByDeletingPathExtension stringByAppendingString:SDImageTransformerKeySeparator] stringByAppendingString:transformerKey] stringByAppendingPathExtension:ext];
...
- (NSString *)transformerKey {
    return [NSString stringWithFormat:@"SDImageRoundCornerTransformer(%f,%lu,%f,%@)", self.cornerRadius, (unsigned long)self.corners, self.borderWidth, self.borderColor.jx_hexString];
}
...
- (UIImage *)transformedImageWithImage:(UIImage *)image forKey:(NSString *)key {
    ...
    return [image jx_roundedCornerImageWithRadius:self.cornerRadius corners:self.corners borderWidth:self.borderWidth borderColor:self.borderColor];
}
...
- (UIImage *)transformedImageWithImage:(UIImage *)image forKey:(NSString *)key {
    ...
    return [image jx_resizedImageWithSize:self.size scaleMode:self.scaleMode];
}
...
- (UIImage *)transformedImageWithImage:(UIImage *)image forKey:(NSString *)key {
    ...
    return [image jx_croppedImageWithRect:self.rect];
}
...
- (UIImage *)transformedImageWithImage:(UIImage *)image forKey:(NSString *)key {
    ...
    return [image jx_flippedImageWithHorizontal:self.horizontal vertical:self.vertical];
}
...
- (UIImage *)transformedImageWithImage:(UIImage *)image forKey:(NSString *)key {
    ...
    return [image jx_rotatedImageWithAngle:self.angle fitSize:self.fitSize];
}
...
- (NSString *)transformerKey {
    return [NSString stringWithFormat:@"SDImageTintTransformer(%@)", self.tintColor.jx_hexString];
}
...
- (UIImage *)transformedImageWithImage:(UIImage *)image forKey:(NSString *)key {
    ...
    return [image jx_tintedImageWithColor:self.tintColor];
}
...
- (UIImage *)transformedImageWithImage:(UIImage *)image forKey:(NSString *)key {
    ...
    return [image jx_blurredImageWithRadius:self.blurRadius];
}
...
- (UIImage *)transformedImageWithImage:(UIImage *)image forKey:(NSString *)key {
    ...
    return [image jx_filteredImageWithFilter:self.filter];
}
