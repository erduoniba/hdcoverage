 ...
 */
@interface PGSDWebImageDownloader : NSObject
 ...
 */
@property (nonatomic, class, readonly, nonnull) PGSDWebImageDownloader *sharedDownloader;
 ...
 */
@interface PGSDWebImageDownloader (SDImageLoader) <SDImageLoader>
