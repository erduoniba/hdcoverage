 ...
 */
- (void)imagePrefetcher:(nonnull PGSDWebImagePrefetcher *)imagePrefetcher didPrefetchURL:(nullable NSURL *)imageURL finishedCount:(NSUInteger)finishedCount totalCount:(NSUInteger)totalCount;
 ...
 */
- (void)imagePrefetcher:(nonnull PGSDWebImagePrefetcher *)imagePrefetcher didFinishWithTotalCount:(NSUInteger)totalCount skippedCount:(NSUInteger)skippedCount;
 ...
 */
@interface PGSDWebImagePrefetcher : NSObject
 ...
 */
@property (strong, nonatomic, readonly, nonnull) PGSDWebImageManager *manager;
 ...
 */
@property (nonatomic, class, readonly, nonnull) PGSDWebImagePrefetcher *sharedImagePrefetcher;

/**
 * Allows you to instantiate a prefetcher with any arbitrary image manager.
 */
- (nonnull instancetype)initWithImageManager:(nonnull PGSDWebImageManager *)manager NS_DESIGNATED_INITIALIZER;
