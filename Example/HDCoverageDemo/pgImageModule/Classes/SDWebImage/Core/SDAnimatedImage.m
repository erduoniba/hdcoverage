...
- (instancetype)initWithAnimatedCoder:(id<SDAnimatedImageCoder>)animatedCoder scale:(CGFloat)scale {
    ...
    if (self) {
        ...
        SDImageFormat format = [NSData jx_imageFormatForImageData:data];
...
- (NSUInteger)jx_memoryCost {
    NSNumber *value = objc_getAssociatedObject(self, @selector(jx_memoryCost));
    if (value != nil) {
...
- (nullable NSData *)jx_imageData {
    ...
    if (imageData) {
        ...
        return [self jx_imageDataAsFormat:self.animatedImageFormat];
    }
}
...
- (nullable NSData *)jx_imageDataAsFormat:(SDImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly {
    if (firstFrameOnly) {
        ...
        return [super jx_imageDataAsFormat:imageFormat compressionQuality:compressionQuality firstFrameOnly:firstFrameOnly];
    }
    ...
    NSData *imageData = [animatedImage jx_imageDataAsFormat:imageFormat compressionQuality:compressionQuality firstFrameOnly:firstFrameOnly];
    return imageData;
}
