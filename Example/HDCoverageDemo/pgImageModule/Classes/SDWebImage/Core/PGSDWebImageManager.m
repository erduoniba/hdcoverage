...
@interface PGSDWebImageCombinedOperation ()
...
@property (weak, nonatomic, nullable) PGSDWebImageManager *manager;

@end

@interface PGSDWebImageManager () {
...
@property (strong, nonatomic, readwrite, nonnull) PGSDImageCache *imageCache;
@property (strong, nonatomic, readwrite, nonnull) id<SDImageLoader> imageLoader;
@property (strong, nonatomic, nonnull) NSMutableSet<NSURL *> *failedURLs;
@property (strong, nonatomic, nonnull) NSMutableSet<PGSDWebImageCombinedOperation *> *runningOperations;

@end

@implementation PGSDWebImageManager
...
- (nonnull instancetype)init {
    ...
    if (!cache) {
        cache = [PGSDImageCache sharedImageCache];
    }
    id<SDImageLoader> loader = [[self class] defaultImageLoader];
    if (!loader) {
        loader = [PGSDWebImageDownloader sharedDownloader];
    }
...
- (PGSDWebImageCombinedOperation *)loadImageWithURL:(NSURL *)url
...
- (PGSDWebImageCombinedOperation *)loadImageWithURL:(nullable NSURL *)url
                                            options:(SDWebImageOptions)options
    ...
    PGSDWebImageCombinedOperation *operation = [PGSDWebImageCombinedOperation new];
    ...
    if (url.absoluteString.length == 0 || (!(options & SDWebImageRetryFailed) && isFailedUrl)) {
        ...
        [self callCompletionBlockForOperation:operation
                                   completion:completedBlock
                                        error:[NSError errorWithDomain:SDWebImageErrorDomain code:code userInfo:@{NSLocalizedDescriptionKey : description}]
                                          url:url];
        return operation;
    }
...
- (void)cancelAll {
    SD_LOCK(_runningOperationsLock);
    NSSet<PGSDWebImageCombinedOperation *> *copiedOperations = [self.runningOperations copy];
    SD_UNLOCK(_runningOperationsLock);
...
- (void)callCacheProcessForOperation:(nonnull PGSDWebImageCombinedOperation *)operation
                                    ...
                                    [self callCompletionBlockForOperation:operation
                                                               completion:completedBlock
                                                                    error:[NSError errorWithDomain:SDWebImageErrorDomain
                                                                                          ...
                                                                                          userInfo:@{NSLocalizedDescriptionKey : @"Operation cancelled by user during querying the cache"}]
                                                                      url:url];
...
- (void)callOriginalCacheProcessForOperation:(nonnull PGSDWebImageCombinedOperation *)operation
                                         url:(nonnull NSURL *)url
                                     options:(SDWebImageOptions)options
                                     context:(nullable SDWebImageContext *)context
                                    progress:(nullable SDImageLoaderProgressBlock)progressBlock
...
// Download process
- (void)callDownloadProcessForOperation:(nonnull PGSDWebImageCombinedOperation *)operation
                                    url:(nonnull NSURL *)url
                                options:(SDWebImageOptions)options
...
// Store cache process
- (void)callStoreCacheProcessForOperation:(nonnull PGSDWebImageCombinedOperation *)operation
                                      url:(nonnull NSURL *)url
                                  options:(SDWebImageOptions)options
                                  context:(SDWebImageContext *)context
    ...
    shouldTransformImage = shouldTransformImage && (!downloadedImage.jx_isAnimated || (options & SDWebImageTransformAnimatedImage));
    shouldTransformImage = shouldTransformImage && (!downloadedImage.jx_isVector || (options & SDWebImageTransformVectorImage));
...
// Transform process
- (void)callTransformProcessForOperation:(nonnull PGSDWebImageCombinedOperation *)operation
                                     url:(nonnull NSURL *)url
                                 options:(SDWebImageOptions)options
                                 context:(SDWebImageContext *)context
    ...
    shouldTransformImage = shouldTransformImage && (!originalImage.jx_isAnimated || (options & SDWebImageTransformAnimatedImage));
    shouldTransformImage = shouldTransformImage && (!originalImage.jx_isVector || (options & SDWebImageTransformVectorImage));
...
- (void)safelyRemoveOperationFromRunning:(nullable PGSDWebImageCombinedOperation *)operation {
    if (!operation) {
        return;
    }
    SD_LOCK(_runningOperationsLock);
...
- (void)callCompletionBlockForOperation:(nullable PGSDWebImageCombinedOperation *)operation
...
- (BOOL)shouldBlockFailedURLWithURL:(nonnull NSURL *)url error:(nonnull NSError *)error options:(SDWebImageOptions)options context:(nullable SDWebImageContext *)context {
    id<SDImageLoader> imageLoader;
    if ([context[SDWebImageContextImageLoader] conformsToProtocol:@protocol(SDImageLoader)]) {
        imageLoader = context[SDWebImageContextImageLoader];
    } else {
...
@implementation PGSDWebImageCombinedOperation
