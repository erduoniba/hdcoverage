...
@interface PGSDWebImageDownloader () <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
...
@implementation PGSDWebImageDownloader {
...
- (void)invalidateSessionAndCancel:(BOOL)cancelPendingOperations {
    if (self == [PGSDWebImageDownloader sharedDownloader]) {
        return;
    }
...
- (nullable NSOperation<SDWebImageDownloaderOperation> *)createDownloaderOperationWithUrl:(nonnull NSURL *)url
    ...
    if (operationClass && [operationClass isSubclassOfClass:[NSOperation class]] && [operationClass conformsToProtocol:@protocol(SDWebImageDownloaderOperation)]) {
        ...
        operationClass = [PGSDWebImageDownloaderOperation class];
    }
...
@implementation PGSDWebImageDownloader (SDImageLoader)
