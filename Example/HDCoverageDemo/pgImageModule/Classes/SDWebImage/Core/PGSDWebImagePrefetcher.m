...
@property (nonatomic, weak) PGSDWebImagePrefetcher *prefetcher;
...
@interface PGSDWebImagePrefetcher ()

@property (strong, nonatomic, nonnull) PGSDWebImageManager *manager;
...
@implementation PGSDWebImagePrefetcher
...
- (nonnull instancetype)init {
    return [self initWithImageManager:[PGSDWebImageManager new]];
}

- (nonnull instancetype)initWithImageManager:(PGSDWebImageManager *)manager {
    if ((self = [super init])) {
        _manager = manager;
