 ...
 */
+ (nonnull CFStringRef)jx_UTTypeFromImageFormat:(SDImageFormat)format CF_RETURNS_NOT_RETAINED NS_SWIFT_NAME(jx_UTType(from:));
 ...
 */
+ (SDImageFormat)jx_imageFormatFromUTType:(nonnull CFStringRef)uttype;
