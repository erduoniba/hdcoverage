...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)jx_imageDataAsFormat:(SDImageFormat)imageFormat NS_SWIFT_NAME(jx_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)jx_imageDataAsFormat:(SDImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(jx_imageData(as:compressionQuality:));
...
- (nullable NSData *)jx_imageDataAsFormat:(SDImageFormat)imageFormat
                       compressionQuality:(double)compressionQuality
                           firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(jx_imageData(as:compressionQuality:firstFrameOnly:));
